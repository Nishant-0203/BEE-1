...
import { getColorFromTitle } from "../utils/colorHelper.js";
...
export const addNote = async (req, res, next) => {
  ...
  try {
    const color = getColorFromTitle(title); // Assign color based on title
...
export const editNote = async (req, res, next) => {
  ...
  try {
    if (title) {
      note.title = title;
      note.color = getColorFromTitle(title); // Update color when title changes
    }
